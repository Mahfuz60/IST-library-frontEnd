...
const Footer = () => {
  return (
    <Box sx={{ flexGrow: 1, mb: 0, mt: 5, backgroundColor: "#1B4F72" }}>
      ...
      >
        ...
        >
          ...
          >
            <CardContent>
              <Typography
                sx={{ textAlign: "start", m: 1, color: "white" }}
                variant="h5"
                component="div"
              >
                SERVICES
      ...
      <Typography
        sx={{ textAlign: "center", mt: 1, mb: 0, pb: 1, color: "white" }}
        variant="body2"
      >
